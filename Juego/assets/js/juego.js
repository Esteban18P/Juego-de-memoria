...
var juego = (function() {
    ...
    var cantidad_vidas = 5,
        cartas = [1,2,3,4,5,6,7,8],
        baraja_uno, baraja_dos, baraja_tres, baraja_cuatro,
    ...
    crear_cartas = function(){
        try{
            ...
            contenedor.innerHTML = cartas_html;//escribir sobre el documentor pero sobre el selector
    ...
    accion_click = function(element){
        try{
            ...
            if(document.querySelectorAll(".checked-item").length == (cartas.length * 2)){
                var mensaje= document.querySelector("#contenedor-mensaje_victoria");
        ...
        try{
            ...
            if(cantidad_vidas == 1){
               ...
               // alert("ha sido eliminado");
                var mensaje= document.querySelector("#contenedor-mensaje_derrota");
                if(mensaje.classList.contains("ocultar-mensaje")){
                    mensaje.classList.remove("ocultar-mensaje");
                }
            }
